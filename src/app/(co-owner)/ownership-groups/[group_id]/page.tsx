          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="flex justify-end gap-4">
              {myMember && (
                <button
                  onClick={handleLeave}
                  disabled={deleting === myMember.member_id}
                  className="bg-red-600 text-white px-8 py-4 rounded-2xl font-bold hover:bg-red-700 transition shadow-xl disabled:opacity-50"
                >
                  {deleting === myMember.member_id ? (
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="flex gap-3">
                      ...
                      <button
                        ...
                        className="p-3 bg-red-100 text-red-600 rounded-xl hover:bg-red-200 transition disabled:opacity-50 inline-flex items-center justify-center"
                      >
