...
export default function Sidebar({ open, setOpen }: SidebarProps) {
  ...
  const menuItems = [
    ...
    { href: "/vehicles-manage-staff", label: "Xe điện", icon: Car },
    { href: "/ownership-groups-manage-staff", label: "Nhóm đồng sở hữu", icon: Users },
    { href: "/appointments-staff", label: "Danh sách đặt lịch xe", icon: Calendar },
    { href: "/co-owners-history-staff", label: "Lịch sử sử dụng xe", icon: History},
    { href: "digital-signatures-staff", label: "Check-in / Check-out", icon: User },
    { href: "/conflicts-staff", label: "Xung đột", icon: Flame },
